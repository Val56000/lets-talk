...
let tite_citation = document.querySelector('#citation');
console.log(tite_citation);
 ...
 let new_citation = () => {
    ...
    let dernier = citations[nombreAleatoire][0];
    let autor = citations[nombreAleatoire][1];
    console.log(dernier);
    
    let phrase =  dernier;
    tite_citation.innerHTML = phrase;
    auteur.innerHTML = autor;



 }

 btn.addEventListener('click', new_citation);